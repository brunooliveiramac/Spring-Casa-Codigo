...
public class AppWebConfiguration extends WebMvcConfigurerAdapter {
				...
				@Override
				public void addInterceptors(InterceptorRegistry registry) { //intercionalização. Adicionando interceptadores
					registry.addInterceptor(new LocaleChangeInterceptor());
				}
				
				public LocaleResolver localeResolver (){//Spring guarda locale através de cookie
