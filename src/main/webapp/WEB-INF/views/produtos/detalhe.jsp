...
<form:form servletRelativeAction="/carrinho/add" method="POST" cssClass="adicionarAoCarrinho">
	...
	<c:forEach items="${produto.precos }" var="preco">
		<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
			<input type="radio" name="tipoPreco" id="tipo" value="${preco.tipo }" checked>
			...
			<button class="adicionarAoCarrinho-botaoComprar" type="submit" name="id" value="10263481793" title="Compre o "${produto.titulo }>
				Comprar
			</button>
		</li>
	  </c:forEach>
<%-- 	  		<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"> <!-- Para dizer q este formulario foi gerado pelo nosso servidor -->
 --%>	  
	</ul>
</form:form>
	...
	<h2 class="infoSection-titulo">
		...
		<p class="infoSection-texto">
			...
			<a class="conteudoDoLivro-link" href="/pages/sumario-javaee">Veja o sumário completo</a>
...
<section class="compartilhar infoSection">
    ...
    <a class="compartilhar-facebook" href="http://www.facebook.com/sharer/sharer.php?u=http://www.casadocodigo.com.br/products/livro-javaee" rel="nofollow" title="Compartilhe no Facebook" rel="nofollow" target="_blank">Compartilhe no Facebook</a>
    <a class="compartilhar-twitter" href="https://twitter.com/home?status=Java EE na @casadocodigo http://www.casadocodigo.com.br/products/livro-javaee" rel="nofollow" title="Compartilhe no Twitter" rel="nofollow" target="_blank">Compartilhe no Twitter</a>
</section>
