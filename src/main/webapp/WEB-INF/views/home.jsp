...
<title>Livros de Java, SOA, Android, iPhone, Ruby on Rails e muito mais - Casa do Código</title>
    ...
    <meta property="og:image" content="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/logo-social.jpg?1057931688501172147" />
			...
			<div class="cabecalhoPrincipal-categoriasEBusca" role="presentation">
				<nav role="navigation" aria-label="Categorias de livros" class="colecoesDaCDC">
 				...
 				<%--<sec:authorize access="isAuthenticated()">
 						<li class="colecoesDaCDC-colecaoItem">
							<a href = "${s:mvcUrl('PC#form').build() }" class="colecoesDaCDC-colecaoLink">Cadastro Produtos</a>
						</li>
					 
						<li class="colecoesDaCDC-colecaoItem">
							<a href = "${s:mvcUrl('PC#listar').build() }"  class="colecoesDaCDC-colecaoLink">Produtos</a>
						</li>
					</sec:authorize> --%>
...
<div class="imagemLivroNinja vitrineDestacao-item-imagem" role="img">
	...
	<div class="imagemLivroNinja-cel" style="" role="presentation">
		<svg width="85px" viewBox="0 0 85 170" style="width: 100%; height: 1px; padding-bottom: 200%; padding-bottom: calc(100%*170/85 - 1px); overflow: visible;" preserveAspectRatio="xMidYMin slice" role="presentation">
			...
			<li class="livroNaVitrine vitrineDestacao-item vitrineDestacao-itemSecundario">
				<a href="/products/livro-spring-framework" class="livroNaVitrine-link">
					<img class="livroNaVitrine-imagem vitrineDestacao-item-imagem"
						 src="//cdn.shopify.com/s/files/1/0155/7645/products/spring-framework-featured_large.png?v=1411567960"
						 alt="Livro de Spring Framework"
						 title="Livro de Spring Framework"
					>
					<div class="vitrineDestacao-item-info" role="presentation">
			...
			<li class="livroNaVitrine vitrineDestacao-item vitrineDestacao-itemSecundario">
				<a href="/products/livro-python-3" class="livroNaVitrine-link">
					<img class="livroNaVitrine-imagem vitrineDestacao-item-imagem"
						 src="//cdn.shopify.com/s/files/1/0155/7645/products/python3-featured_large.png?v=1441973789"
						 alt="Livro Python 3"
						 title="Livro Python 3"
					>
					<div class="vitrineDestacao-item-info" role="presentation">
						<h2 class="vitrineDestacao-item-nome livroNaVitrine-nome">
						  
							Python 3: Seus primeiros programas
	...
	<ul class="vitrineDestaquinho-lista">
		...
		<li class="livroNaVitrine vitrineDestaquinho-produto">
			<a href="${s:mvcUrl('PC#detalhe').arg(0, produto.id).build()}" class="livroNaVitrine-link">
				<div class="livroNaVitrine-imagemContainer" role="presentation">
					<img class="livroNaVitrine-imagem" src="//cdn.shopify.com/s/files/1/0155/7645/products/5LRsiQ-WvbmgPiUbF3xe1Is6RcorSCk5tuYbR0A__3Q_size_mode_3_size_800x600_large.jpeg?v=1452288754" alt="Livro de lógica do jogo" title="Livro de lógica do jogo">
